...
import { Loader2, History, PanelLeftClose, ChevronRight, ChevronDown, Activity, ChevronUp, FileText, Settings } from "lucide-react";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Settings Section */}
        {user && (
          <div className="border-t border-zinc-200/60 bg-zinc-50 p-3 space-y-2.5">
            ...
            {telegramLoading ? (
              ...
              <div className="flex items-center gap-2 rounded-lg bg-emerald-50 px-3 py-2 ring-1 ring-emerald-500/20">
                <svg className="h-3.5 w-3.5 text-emerald-600 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-[10px] font-medium text-emerald-800">Telegram alerts connected</span>
              </div>
            ) : (
              <a
                ...
                className="flex items-center gap-2.5 rounded-lg bg-blue-50/80 px-3 py-2.5 ring-1 ring-blue-500/10 transition hover:bg-blue-100/80 group"
              >
                <svg className="h-4 w-4 fill-blue-600 shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.892-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>
                <div>
                  <p className="text-[11px] font-semibold text-blue-900">Connect Telegram</p>
                  <p className="text-[9px] text-blue-700/70">Get daily reports on your phone</p>
                </div>
              </a>
            )}
          </div>
        ...
        <div className="p-3 border-t border-zinc-200/60 bg-zinc-50">
